...
const BASE_LOCALE_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    'topicEditor.layout': 'Layout',
    'topicEditor.editTextAria': 'Edit topic text',
    'topicEditor.inheritLayout': 'Inherit layout',
  ...
  'zh-CN': Object.freeze({
    ...
    'topicEditor.layout': '布局',
    'topicEditor.editTextAria': '编辑主题文本',
    'topicEditor.inheritLayout': '继承布局',
    'topicEditor.save': '保存',
  ...
  'zh-TW': Object.freeze({
    ...
    'topicEditor.layout': '佈局',
    'topicEditor.editTextAria': '編輯主題文字',
    'topicEditor.inheritLayout': '繼承佈局',
    'topicEditor.save': '儲存',
...
const ADDITIONAL_LOCALE_MESSAGES = Object.freeze({
  ...
  fr: Object.freeze(
    createAdditionalLocale({
      ...
      inheritLayout: 'Hériter de la disposition',
      save: 'Enregistrer',
  ...
  ru: Object.freeze(
    createAdditionalLocale({
      ...
      inheritLayout: 'Наследовать макет',
      save: 'Сохранить',
  ...
  id: Object.freeze(
    createAdditionalLocale({
      ...
      inheritLayout: 'Warisi tata letak',
      save: 'Simpan',
  ...
  hi: Object.freeze(
    createAdditionalLocale({
      ...
      topicColor: 'विषय रंग',
      topicIcon: 'विषय आइकन',
      inheritLayout: 'लेआउट विरासत में लें',
      save: 'सहेजें',
...
function createAdditionalLocale(text) {
  return {
    ...
    'topicEditor.layout': text.layout,
    'topicEditor.inheritLayout': text.inheritLayout,
